import 'controller/cartpage_orderfailed_controller.dart';
import 'package:flutter/material.dart';
import 'package:tran_quoc__tuantq_s_application1/core/app_export.dart';
import 'package:tran_quoc__tuantq_s_application1/widgets/custom_button.dart';

// ignore_for_file: must_be_immutable
class CartpageOrderfailedDialog extends StatelessWidget {
  CartpageOrderfailedDialog(this.controller);
        ...
        child: Column(
            ...
            children: [
              Align(
                  ...
                  child:
                    ...
                    CustomImageView(
                        ...
                        height: getSize(18),
                        width: getSize(18),
                        margin: getMargin(left: 110, top: 4, bottom: 1),
                        onTap: () {
                          onTapImgClose();
                        })
                  ])),
              ...
              Container(
                  ...
                  margin: getMargin(left: 5, top: 23, right: 5),
                  child: Text("msg_odeme_sirasinda".tr,
                      maxLines: null,
                      textAlign: TextAlign.center,
                      style: AppStyle.txtNotoSansMedium14Gray500)),
              CustomButton(
                  text: "lbl_tekrar_dene".tr.toUpperCase(),
                  margin: getMargin(top: 23, bottom: 1),
