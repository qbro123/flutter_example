...
class Listavatarphoto2ItemWidget extends StatelessWidget {
  Listavatarphoto2ItemWidget(this.listavatarphoto2ItemModelObj);

  Listavatarphoto2ItemModel listavatarphoto2ItemModelObj;

  var controller = Get.find<NotifypageSwipeRightItemController>();
