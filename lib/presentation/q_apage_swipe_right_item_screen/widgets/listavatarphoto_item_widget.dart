...
class ListavatarphotoItemWidget extends StatelessWidget {
  ListavatarphotoItemWidget(this.listavatarphotoItemModelObj);

  ListavatarphotoItemModel listavatarphotoItemModelObj;

  var controller = Get.find<QApageSwipeRightItemController>();
