...
class Listavatarphoto1ItemWidget extends StatelessWidget {
  Listavatarphoto1ItemWidget(this.listavatarphoto1ItemModelObj);

  Listavatarphoto1ItemModel listavatarphoto1ItemModelObj;

  var controller = Get.find<NotifypageScrollviewController>();
