...
class AddressespageEditaddressScreen
    extends GetWidget<AddressespageEditaddressController> {
  @override
                          ...
                          child: Column(
                              ...
                              children: [
                                              ...
                                              child: Row(children: [
                                                ...
                                                CustomDropDown(
                                                    ...
                                                    fontStyle: DropDownFontStyle
                                                        .NotoSansRegular16,
                                                    items: controller
                                                        .addressespageEditaddressModelObj
                                                        .value
                                                        .dropdownItemList,
                                                    onChanged: (value) {
                                                      controller
                                ...
                                CustomButton(
                                    ...
                                    margin:
                                        getMargin(left: 23, top: 28, right: 24),
                                    variant: ButtonVariant.OutlineBlue60019),
                                Padding(
                                    padding: getPadding(top: 20, bottom: 222),
